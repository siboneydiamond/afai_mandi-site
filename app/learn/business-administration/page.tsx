...
export default function BusinessAdministrationPage() {
  const courses = [
    {
      title: "Business Fundamentals with AI",
    ...
    },
    {
      ...
      institution: "AFAI Finance Institute",
      type: "Professional Certificate",
      courses: "4 Courses",
      level: "Beginner",
      duration: "2 months",
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-slate-900 text-white py-16 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-5xl font-bold mb-6">Business Administration Courses</h1>
          <p className="text-xl text-slate-300 max-w-3xl">
            Master the fundamentals of business administration with AI-enhanced courses covering management, strategy,
      ...
      <section className="py-12 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            <h2 className="text-2xl font-bold">127 courses available</h2>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-6 bg-slate-50 rounded-lg">
              <h3 className="text-xl font-bold mb-3">Business Analyst</h3>
              <p className="text-slate-600 mb-4">
                Use data and AI tools to solve business problems and drive strategic decisions.
              </p>
              <p className="text-sm text-slate-500">Average salary: $75,000 - $95,000</p>
            </div>
            <div className="p-6 bg-slate-50 rounded-lg">
              <h3 className="text-xl font-bold mb-3">Project Manager</h3>
              <p className="text-slate-600 mb-4">
                Lead teams and manage projects using modern AI-powered tools and methodologies.
              </p>
              <p className="text-sm text-slate-500">Average salary: $80,000 - $110,000</p>
            </div>
            <div className="p-6 bg-slate-50 rounded-lg">
              <h3 className="text-xl font-bold mb-3">Operations Manager</h3>
              <p className="text-slate-600 mb-4">Optimize business operations and processes with AI-driven insights.</p>
              <p className="text-sm text-slate-500">Average salary: $70,000 - $100,000</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-6 bg-yellow-500">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg mb-8">Join thousands of learners building business administration skills with AI</p>
