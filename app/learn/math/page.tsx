...
export default function MathPage() {
  const courses = [
    ...
    },
    {
      ...
      institution: "AFAI Data Institute",
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-slate-900 text-white py-16 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-5xl font-bold mb-6">Math Courses</h1>
          <p className="text-xl text-slate-300 max-w-3xl">
            Build strong mathematical foundations in algebra, calculus, statistics, and applied mathematics for AI and
            data science.
          </p>
        </div>
      </section>
      ...
      <section className="py-12 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            <h2 className="text-2xl font-bold">78 courses available</h2>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-6 bg-slate-50 rounded-lg">
              <h3 className="text-xl font-bold mb-3">Data Analyst</h3>
              <p className="text-slate-600 mb-4">Use statistical methods and mathematical models to analyze data.</p>
              <p className="text-sm text-slate-500">Average salary: $65,000 - $90,000</p>
            </div>
            <div className="p-6 bg-slate-50 rounded-lg">
              <h3 className="text-xl font-bold mb-3">Quantitative Analyst</h3>
              <p className="text-slate-600 mb-4">Apply advanced mathematics to financial and business problems.</p>
              <p className="text-sm text-slate-500">Average salary: $85,000 - $120,000</p>
            </div>
            <div className="p-6 bg-slate-50 rounded-lg">
              <h3 className="text-xl font-bold mb-3">Research Scientist</h3>
              <p className="text-slate-600 mb-4">Conduct research using mathematical modeling and analysis.</p>
              <p className="text-sm text-slate-500">Average salary: $75,000 - $110,000</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-6 bg-yellow-500">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-lg mb-8">Join thousands building mathematical skills for AI and data science</p>
