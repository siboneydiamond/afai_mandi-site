  ...
  const courses = [
    {
      ...
      institution: "AFAI Design School",
    ...
    {
      title: "Graphic Design with AI Tools",
      institution: "AFAI Creative Institute",
      type: "Course",
      level: "Beginner",
      duration: "5 weeks",
      image: "/placeholder.svg?height=200&width=400",
    },
    {
      ...
      institution: "AFAI Product Academy",
      type: "Professional Certificate",
      courses: "7 Courses",
      level: "Intermediate",
      duration: "4 months",
    ...
    },
    {
      ...
      institution: "AFAI Innovation Lab",
      type: "Course",
      level: "Intermediate",
      duration: "6 weeks",
      image: "/placeholder.svg?height=200&width=400",
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-slate-900 text-white py-16 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-5xl font-bold mb-6">Design Courses</h1>
          <p className="text-xl text-slate-300 max-w-3xl">
            Master design principles, tools, and processes with AI-enhanced courses in UI/UX, graphic design, and
            product design.
          </p>
        </div>
      </section>
      ...
      <section className="py-12 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center justify-between mb-8">
            <h2 className="text-2xl font-bold">94 courses available</h2>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="p-6 bg-slate-50 rounded-lg">
              <h3 className="text-xl font-bold mb-3">UX Designer</h3>
              <p className="text-slate-600 mb-4">
                Create user-centered designs that enhance digital experiences with AI tools.
              </p>
              <p className="text-sm text-slate-500">Average salary: $75,000 - $105,000</p>
            </div>
            <div className="p-6 bg-slate-50 rounded-lg">
              <h3 className="text-xl font-bold mb-3">Product Designer</h3>
              <p className="text-slate-600 mb-4">Design complete product experiences from concept to launch.</p>
            ...
            <div className="p-6 bg-slate-50 rounded-lg">
              ...
              <p className="text-slate-600 mb-4">Create visual content for brands, marketing, and digital media.</p>
              <p className="text-sm text-slate-500">Average salary: $50,000 - $75,000</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 px-6 bg-yellow-500">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-4">Ready to create amazing designs?</h2>
          <p className="text-lg mb-8">Join thousands learning design skills with AI-powered courses</p>
